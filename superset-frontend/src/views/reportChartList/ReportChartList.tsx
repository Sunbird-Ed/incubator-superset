...
class ReportChartList extends React.PureComponent<Props, State> {
  static propTypes = {
  ...
  columns = [
    {
      Cell: ({
        row: {
          original: { report_url, slice_name: sliceName },
        },
      }: any) => <a href={report_url}>{sliceName}</a>,
      Header: t('Chart'),
      accessor: 'slice_name',
      sortable: true,
    },
...
export default withToasts(ReportChartList);
